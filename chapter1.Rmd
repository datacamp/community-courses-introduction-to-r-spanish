...
En el **editor** a la derecha puedes escribir el código para resolver los ejercicios.

R utiliza el símbolo `#` para añadir comentarios en el código. Comentar el código es un buen habito a desarrollar pues indica a las personas (incluyendo nosotros mismos) leyendo el código que es lo que éste hace.

Los comentarios no modifican las instrucciones que escribimos en R de ninguna manera.  

Las salidas del código escrito en el editor aparecen en la **consola** (R console) abajo a la derecha, mientras que los **gráficos** se muestran en la esquina superior derecha.
...
- Puedes ver que R ha producido algunos gráficos en la esquina superior derecha. Puedes usar las flechas para navegar por los gráficos. 

*** =hint
Solo da clic al botton 'Submit Answer'
...
# El símbolo de numeral (hashtag) es utilizada para hacer comentarios

# La siguiente línea de código muestra una demostración de las gráficas en R.
demo("graphics")
...
- Escribe `17%%4` para calcular el 17 módulo 4.
...
test_output_contains("17%%4", incorrect_msg = "Parece haber un problema con la parte del módulo. Asegúrate de haber leido las instrucciones.")
