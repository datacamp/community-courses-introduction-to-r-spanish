...
--- type:NormalExercise xp:100 key:4db760f93d
...
--- type:NormalExercise xp:100 key:72ff62da0f
## Selección Avanzada
...
test_object("positivos_ruleta", 
            undefined_msg = "Aseg&#250;rate de definir la variable <code>positivos_ruleta</code>.",
...
test_object("ganancias_ruleta",
            undefined_msg = "Aseg&#250;rate de definir la variable <code>ganancias_ruleta</code>.",
            incorrect_msg = "Parece que <code>positivos_ruleta</code> no contiene el resultado esperado. Por favor, intenta de nuevo.")
success_msg("Excelente! Ahora sabemos lo b&#224;sico de los vectores, los cuales son estructuras de datos sumamente importantes en R. En el siguiente cap&#237;tulo introduciremos la versi&#243;n de dos dimensiones de los vectores: las matrices.")
```
